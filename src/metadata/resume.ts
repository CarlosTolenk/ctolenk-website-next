  ...
  content: {
    ...
    educationHistory: [
      ...
      },
      {
        ...
        title: 'Varios para mantener actualizad',
        timeElapsed: 'Sep 2018 - Till Now',
        description: '',
      },
      {
        imageAtl: 'Platzi',
      ...
      },
      {
        ...
        company: 'Platzi',
        imageURL: '/images/platzi.png',
        title: 'Advanced PHP and Laravel ',
        timeElapsed: 'Apr 2018 - Dic 2018',
        description: '',
      },
      {
        imageAtl: 'udemy',
