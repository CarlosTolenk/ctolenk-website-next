...
import {
    ...
    faCode, faMicrophoneAlt,
    faDesktop, faCamera, faSmileBeam, faAward, faLightbulb,
    faPlay, faStarHalf, faStar,
                        ...
                        <div className="row pb-30">
                            <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <span className="about-location">
                                      <FontAwesomeIcon className="mr-1" color={'#d32e2e'} size={"lg"}
                                                       icon={faMapMarkerAlt}/>
                                        Dominican Republic, La Romana</span>
                            ...
                            <div className="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div className="pb-30">
                                    <div className="counter-block">
                                        ...
                                        <h4>Happy Clients</h4>
                                        <span className="counter-block-value" data-count="1000">0</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div className="pb-30">
                                    <div className="counter-block">
                                        ...
                                        <span className="counter-block-value" data-count="7">0</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div className="pb-30">
                                    <div className="counter-block">
                                        ...
                                        <h4>Awards Won</h4>
                                        <span className="counter-block-value" data-count="15">0</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div className="pb-30">
                                    <div className="counter-block">
                                        ...
                                        <h4>Meetings</h4>
                                        <span className="counter-block-value" data-count="500">0</span>
                                    </div>
                                </div>
                            </div>
